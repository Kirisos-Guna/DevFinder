...
export default function Home() {
  const [userName, setUserName] = useState("kirisos-Guna");
      ...
      <div className="  mx-auto flex w-full max-w-[600px] flex-col gap-8  rounded p-2">
        ...
        <section className="flex flex-col gap-6">
          ...
          {data?.message ? (
           ...
           <section>
            <p className="px-4 py-8 text-center">Want to support creator? Consider Donating</p>
           
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <a href="https://www.buymeacoffee.com/Kirisosguna" rel="noopener noreferrer">
    <img
